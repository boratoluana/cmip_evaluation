%% ----------------- PRESSURE GRADIENT -----------------------------
% 
% This script calculates the atmspheric pressure gradient for all models
%
% Requirements: Statistical Toolbox; function dist2; 
% masc.mat (WT_data directory)
%
...
for i = 1:size(models,1)
   gradient_press.psl_grad{1,i} = cat(1,psl_sea{1,i}, pslgrad_sea{1,i});
   gradient_press.psl_grad{1,i} = permute(gradient_press.psl_grad{1,i},[2 1])
end
